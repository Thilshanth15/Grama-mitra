    ...
    <PublicLayout>
      ...
      <div style={{
        ...
        <div className="container-sm" style={{ position: 'relative', zIndex: 2 }}>
          ...
          {/* Full Voice Output Control Toolbar (Repeat, Stop, Mute, Type Instead) */}
          {(result && result.response) && (
            <div style={{
              ...
              <div style={{
                ...
                borderRadius: '9999px',
                backdropFilter: 'blur(20px)',
                boxShadow: '0 8px 30px rgba(0, 0, 0, 0.6), inset 0 1px 1px rgba(255, 255, 255, 0.25)',
                flexWrap: 'wrap',
                justifyContent: 'center',
              }}>
                <span style={{ fontSize: '0.85rem', fontWeight: 800, color: '#c084fc', display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
                  <Volume2 size={15} color="#c084fc" />
                  {language === 'en' ? 'Voice Controls:' : 'குரல் கட்டுப்பாடுகள்:'}
                </span>
                ...
                <button
                  ...
                  onClick={() => {
                    if (result?.response) {
                      ...
                      setSpeaking(true);
                      setIsMuted(false);
                      addToast(language === 'en' ? '🔁 Repeating voice output...' : '🔁 மீண்டும் பேசப்படுகிறது...', 'info');
                    }
                  }}
                  style={{
                    ...
                    color: '#38bdf8', fontSize: '0.8rem', fontWeight: 700, cursor: 'pointer',
                    transition: 'all 0.2s ease',
                  }}
                  title="Repeat Speech"
                >
                ...
                <button
                  ...
                  onClick={() => {
                    stopSpeaking();
                    setSpeaking(false);
                    addToast(language === 'en' ? '🛑 Voice output stopped' : '🛑 குரல் நிறுத்தப்பட்டது', 'warning');
                  }}
                  disabled={!speaking}
                  style={{
                    display: 'inline-flex', alignItems: 'center', gap: '0.4rem',
                    ...
                    border: speaking ? '1px solid rgba(239, 68, 68, 0.6)' : '1px solid rgba(255, 255, 255, 0.15)',
                    color: speaking ? '#f87171' : '#94a3b8', fontSize: '0.8rem', fontWeight: 700, cursor: 'pointer',
                ...
                <button
                  ...
                  onClick={() => {
                    if (isMuted) {
                      ...
                      addToast(language === 'en' ? '🔊 Voice Unmuted' : '🔊 சத்தம் இயக்கப்பட்டது', 'info');
                    } else {
                      setIsMuted(true);
                      stopSpeaking();
                      setSpeaking(false);
                      addToast(language === 'en' ? '🔇 Voice Muted' : '🔇 சத்தம் முடக்கப்பட்டது', 'info');
                    }
                  }}
                  style={{
                    display: 'inline-flex', alignItems: 'center', gap: '0.4rem',
                    ...
                    border: isMuted ? '1px solid rgba(245, 158, 11, 0.6)' : '1px solid rgba(255, 255, 255, 0.2)',
                    color: isMuted ? '#fbbf24' : '#ffffff', fontSize: '0.8rem', fontWeight: 700, cursor: 'pointer',
                  }}
                  title="Mute Audio"
                >
                  {isMuted ? <VolumeX size={13} color="#fbbf24" /> : <Volume2 size={13} color="#34d399" />}
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setSpeaking(false);
                    inputRef.current?.focus();
                    addToast(language === 'en' ? '⌨️ Switch to Typing Mode' : '⌨️ எழுத்து பயன்முறை', 'info');
                  }}
                  style={{
                    display: 'inline-flex', alignItems: 'center', gap: '0.4rem',
                    padding: '0.4rem 0.85rem', borderRadius: '9999px',
          ...
          <div style={{
            ...
            {/* Form Card Container (Ultra-Premium Glassmorphism Theme) */}
            <form onSubmit={handleSchemeSubmit} style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', marginBottom: '1.75rem' }}>
                ...
                {/* Scheme Choice */}
                <div>
                  <label style={{ display: 'block', fontSize: '0.88rem', fontWeight: 800, color: '#fbbf24', marginBottom: '0.5rem', letterSpacing: '0.02em' }}>
                  ...
                  >
                    <option value="PM-KISAN installment verification" style={{ background: '#0f172a', color: '#ffffff' }}>PM-KISAN installment verification (ரூ. 6,000 / ஆண்டு)</option>
                    <option value="PMFBY Crop Insurance Claim (Kharif)" style={{ background: '#0f172a', color: '#ffffff' }}>PMFBY Crop Insurance Claim / பயிர் காப்பீடு</option>
                    <option value="Kisan Credit Card (KCC) Loan Subvention" style={{ background: '#0f172a', color: '#ffffff' }}>Kisan Credit Card (KCC) Loan Subvention / கிசான் கடன் அட்டை</option>
                    <option value="Drip Irrigation Subsidized Kit (PMKSY)" style={{ background: '#0f172a', color: '#ffffff' }}>Drip Irrigation Subsidized Kit (PMKSY) / சொட்டு நீர் பாசனம்</option>
                    <option value="Subsidized Fertilizer & Quality Seed Supply" style={{ background: '#0f172a', color: '#ffffff' }}>Subsidized Fertilizer & Quality Seed Supply / மானிய உரம்</option>
                  </select>
                </div>
              </div>
              ...
              <div style={{
                background: 'linear-gradient(135deg, rgba(6, 78, 59, 0.4) 0%, rgba(2, 132, 199, 0.3) 100%)',
                backdropFilter: 'blur(12px)',
                ...
                <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap' }}>
                  <label style={{ display: 'flex', alignItems: 'center', gap: '0.55rem', cursor: 'pointer', fontSize: '0.9rem', color: '#f8fafc', fontWeight: 700 }}>
              ...
              <div style={{ textAlign: 'center' }}>
                <button
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    gap: '0.75rem',
                    boxShadow: '0 10px 30px rgba(2, 132, 199, 0.45), 0 0 20px rgba(16, 185, 129, 0.3)',
                    transition: 'all 0.25s ease',
                  }}
                  onMouseEnter={e => {
                    e.currentTarget.style.transform = 'translateY(-2px) scale(1.02)';
                    e.currentTarget.style.boxShadow = '0 14px 40px rgba(2, 132, 199, 0.65)';
                  }}
                  onMouseLeave={e => {
                    e.currentTarget.style.transform = 'none';
                    e.currentTarget.style.boxShadow = '0 10px 30px rgba(2, 132, 199, 0.45), 0 0 20px rgba(16, 185, 129, 0.3)';
                  }}
                >
