...
export default function Home() {
  ...
  const handleSchemeSubmit = (e) => {
    ...
    setSubmitSuccess(`Application #${newApp.id.toUpperCase()} Submitted Successfully! Transmitted to ${formDistrict} District (${formBlock} Block) Officer Dashboard.`);
    setFarmerName('');
    setFarmerPhone('');
  ...
  return (
    <PublicLayout>
      ...
      <section className="section" style={{
        background: 'linear-gradient(135deg, #050e1a 0%, #081628 100%)',
        ...
        <div className="container" style={{ maxWidth: 1050 }}>
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            ...
            <h2 style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)', fontWeight: 900, color: '#ffffff', letterSpacing: '-0.02em', marginBottom: '1rem' }}>
            ...
            <p style={{ color: '#94a3b8', fontSize: '1.1rem', maxWidth: '750px', margin: '0 auto', lineHeight: 1.7 }}>
              Fill out your details below to apply for PM-KISAN, PMFBY crop insurance, or KCC loans. Submitted applications are instantly transmitted directly to the **District & Block Officer Dashboard**.
            </p>
          </div>
